...
export default function BookmarkButton({ width = 20, height = 26, desktopWidth, desktopHeight }: BookmarkButtonProps) {
  ...
  return (
    <button type="button" className={styles['bookmark-btn']} onClick={handleClick} aria-label={isBookmarked ? '북마크 해제' : '북마크 추가'}>
      <svg style={cssVars} viewBox="0 0 23 29" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${styles['bookmark-icon']} ${isBookmarked ? styles['active'] : ''}`}>
